...
export default async function MarketplacePage() {
  ...
  const categories = [
    { id: 'home', label: 'Homes', icon: Home, color: '#3B9ECC' },
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-12 items-center reveal-up-start [animation:reveal-up-active_1s_cubic-bezier(0.16,1,0.3,1)_0.3s_forwards]">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full bg-[#f5f0eb] border-0 rounded-full py-4 pl-14 pr-6 text-sm font-medium focus:ring-2 focus:ring-[#3B9ECC] transition-all"
            />
          </div>
        </div>
