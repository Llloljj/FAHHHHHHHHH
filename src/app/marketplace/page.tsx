          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16">
            <div>
              ...
              <h1 className="text-6xl font-black uppercase tracking-tighter text-[#262626]">
                Service <span className="text-[#3B9ECC]">Marketplace</span>
              </h1>
              <p className="text-xl text-[#262626]/70 mt-4 font-medium">Find homes, vehicles, and local food for your trip.</p>
            </div>
          </div>
        </RevealUp>
