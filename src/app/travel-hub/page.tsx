...
export default function TravelHubPage() {
  return (
    <div className="min-h-screen pt-[100px] px-8 md:px-16 bg-[#262626] text-white pb-24 selection:accent-gradient selection:text-[#262626]">
      <div className="max-w-6xl mx-auto">

        {/* Hero Section */}
        <RevealUp className="mb-24">
          <div className="flex items-center gap-4 accent-gradient-text mb-8">
          ...
          <h1 className="text-7xl md:text-[120px] font-black uppercase tracking-tighter leading-[0.8] mb-8">
            BEYOND <br /> <span className="text-transparent border-b-4 accent-gradient-border [-webkit-text-stroke:1px_#3B9ECC]">BORDERS</span>
          </h1>
        ...
        <RevealUp delay={600} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="group p-8 rounded-[40px] bg-white/5 border border-white/10 hover:accent-gradient/10 hover:accent-gradient-border/20 transition-super">
            <Plane className="w-10 h-10 accent-gradient-text mb-6" />
          ...
          <div className="group p-8 rounded-[40px] bg-white/5 border border-white/10 hover:accent-gradient/10 hover:accent-gradient-border/20 transition-super">
            <Train className="w-10 h-10 accent-gradient-text mb-6" />
          ...
          <div className="group p-8 rounded-[40px] bg-white/5 border border-white/10 hover:accent-gradient/10 hover:accent-gradient-border/20 transition-super">
            <Bus className="w-10 h-10 accent-gradient-text mb-6" />
