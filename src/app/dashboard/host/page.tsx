    ...
    return (
      <div className="min-h-screen pt-[100px] px-8 flex items-center justify-center bg-[#fdf8f3]">
        <div className="max-w-md w-full text-center space-y-8 reveal-up-start [animation:reveal-up-active_1s_cubic-bezier(0.16,1,0.3,1)_forwards]">
          <Home className="w-16 h-16 text-[#3B9ECC] mx-auto opacity-20" />
          ...
          <Link href="/marketplace/become-host" className="inline-block bg-[#262626] text-white rounded-full px-8 py-4 text-[10px] font-black uppercase tracking-[0.2em] hover:bg-[#3B9ECC] hover:text-[#262626] transition-super">
            Start Hosting
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          <div className="reveal-up-start [animation:reveal-up-active_1s_cubic-bezier(0.16,1,0.3,1)_forwards]">
            <div className="flex items-center gap-3 text-[#3B9ECC] mb-4">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] bg-[#3B9ECC]/10 px-3 py-1 rounded-full">Verified Host</span>
            </div>
            <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-[#262626] leading-[0.85]">
              HOST <br /> <span className="text-[#3B9ECC]">CENTRAL</span>
            </h1>
          </div>
          <Link href="/marketplace/new" className="bg-[#262626] text-white rounded-full px-8 py-4 text-[10px] font-black uppercase tracking-[0.2em] hover:bg-[#3B9ECC] hover:text-[#262626] transition-super flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 reveal-up-start [animation:reveal-up-active_1s_cubic-bezier(0.16,1,0.3,1)_0.2s_forwards]">
          <Card className="bg-[#262626] text-white border-0 rounded-[32px] overflow-hidden">
            <CardContent className="p-8">
              <Wallet className="w-8 h-8 text-[#3B9ECC] mb-6" />
          ...
          <Card className="bg-white border-0 shadow-xl shadow-[#262626]/5 rounded-[32px] overflow-hidden">
            <CardContent className="p-8">
              <Home className="w-8 h-8 text-[#3B9ECC] mb-6" />
          ...
          <Card className="bg-white border-0 shadow-xl shadow-[#262626]/5 rounded-[32px] overflow-hidden">
            <CardContent className="p-8">
              <CalendarCheck className="w-8 h-8 text-[#3B9ECC] mb-6" />
