    ...
    <Card className="border-0 bg-white rounded-[32px] overflow-hidden shadow-xl shadow-[#262626]/5 group hover:shadow-2xl transition-super">
      <CardContent className="p-0 flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-8 flex flex-col justify-between">
          <div>
            <div className="flex items-center text-[10px] font-black uppercase tracking-[0.2em] text-[#e4a4bd] mb-2">
            ...
            {isHost && booking.status === 'pending' && (
              <div className="flex gap-2">
                <button 
                  ...
                  className="px-6 py-3 rounded-full text-[9px] font-black uppercase tracking-[0.15em] bg-[#262626] text-white hover:bg-[#e4a4bd] hover:text-[#262626] transition-all disabled:opacity-50"
                >
                  {loading ? '...' : 'Approve'}
                </button>
                <button 
