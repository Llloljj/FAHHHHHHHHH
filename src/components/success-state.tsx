  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center reveal-up-start [animation:reveal-up-active_1s_cubic-bezier(0.16,1,0.3,1)_forwards]">
      ...
      <Link href={actionHref}>
        <Button className="bg-[#262626] text-white rounded-full px-12 py-8 text-[12px] font-black uppercase tracking-[0.3em] hover:bg-[#e4a4bd] hover:text-[#262626] transition-super group">
          {actionLabel}
