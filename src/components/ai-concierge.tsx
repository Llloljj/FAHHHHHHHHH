...
export function AiConcierge({ tripContext }: { tripContext: TripContext }) {
  ...
  return (
    <Card className="border-[#262626]/10 shadow-xl shadow-[#262626]/5 rounded-[24px] overflow-hidden flex flex-col h-[600px] border">
      {/* Header */}
      <CardHeader className="bg-[#262626] text-white p-6 pb-4 shrink-0">
        <CardTitle className="text-2xl font-black uppercase tracking-tighter flex items-center justify-between">
          <div className="flex items-center">
            <Bot className="w-6 h-6 mr-3 accent-gradient-text" />
            AI Concierge
          </div>
        ...
        <div className="p-4 bg-white border-t border-[#262626]/5 shrink-0">
          <form onSubmit={handleSubmit} className="relative">
            ...
            <Button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full w-10 h-10 p-0 bg-[#262626] accent-gradient-text hover:accent-gradient hover:text-[#262626] transition-all disabled:opacity-50"
            >
